...
var Rule = /*#__PURE__*/ function() {
    function _Rule(sheet, property, value, selector) {
        ...
        this.hash = stableHash(this.sheet.name, this.joined + joinTruthy(this.selector.preconditions) + (this.selector.pseudoSelector ? this.selector.pseudoSelector : ""));
    }
    _create_class(_Rule, [
        {
            key: "toString",
            value: function toString() {
                var selectors = joinTruthy([
...
var Selector = /*#__PURE__*/ function() {
    function _Selector(sheet, scopeName) {
        var _ref = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {}, pseudoSelector = _ref.pseudoSelector, preconditions = _ref.preconditions;
    ...
    _create_class(_Selector, [
        {
            key: "addPseudoSelector",
            value: function addPseudoSelector(pseudoSelector) {
...
// src/utils/is.ts
var is = {
    pseudoSelector: function(selector, _) {
        return selector.startsWith(":");
    },
    mediaQuery: function(property, _) {
    ...
    validProperty: function(property, value) {
        return (typeof value === "string" || typeof value === "number") && !is.cssVariables(property, value) && !is.pseudoSelector(property, value) && !is.mediaQuery(property, value);
    },
    ...
    function create(styles) {
        ...
        forIn(styles, function(scopeName, styles2) {
            if (is.topLevelClass(scopeName, styles2)) {
                forIn(styles2, function(childScope, value) {
                    var scopeClassName2 = stableHash(sheet.name, childScope);
                    var precondition = scopeName.slice(1);
                    iterateStyles(sheet, value, new Selector(sheet, scopeClassName2, {
            ...
            iterateStyles(sheet, styles2, new Selector(sheet, scopeClassName, {})).forEach(function(className) {
...
function cssVariablesBlock(sheet, styles, selector) {
    ...
    if (chunkRows.length) {
        ...
        sheet.append("".concat(joinSelectors(selector.preconditions.concat(selector.scopeClassName)), " {").concat(output, "}"));
    }
