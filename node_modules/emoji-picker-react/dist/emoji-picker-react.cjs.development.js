...
function getStatusSearchResults(filterState, searchTerm) {
  ...
  var searchResultsCount = ((_Object$entries = Object.entries(filterState == null ? void 0 : filterState[searchTerm])) == null ? void 0 : _Object$entries.length) || 0; // eslint-disable-next-line react-hooks/rules-of-hooks
...
function Button(props) {
  return React.createElement("button", Object.assign({
    ...
    className: flairup.cx('epr-btn', props.className)
  }), props.children);
}
...
function ClickableEmojiButton(_ref) {
  ...
  return React.createElement(Button, {
    className: flairup.cx(ClassNames.emoji, hidden && commonStyles.hidden, hiddenOnSearch && commonStyles.hiddenOnSearch, (_cx = {}, _cx[ClassNames.visible] = !hidden && !hiddenOnSearch, _cx[ClassNames.emojiHasVariations] = hasVariations && showVariations, _cx)),
...
function EmojiImg(_ref) {
  ...
  return React.createElement("img", {
    src: imgUrl,
    alt: emojiName,
    className: flairup.cx(ClassNames.external, 'epr-emoji-img'),
...
function NativeEmoji(_ref) {
  ...
  return React.createElement("span", {
    className: flairup.cx(ClassNames.external, 'epr-emoji-native'),
    "data-unified": unified,
    style: style
...
function EmojiCategory(_ref) {
  ...
  return React.createElement("li", {
    className: flairup.cx(styles.category, hidden && commonStyles.hidden, hiddenOnSearch && commonStyles.hiddenOnSearch),
    "data-name": category,
    "aria-label": categoryName
  }, React.createElement("h2", {
    className: flairup.cx(styles.label)
  }, categoryName), React.createElement("div", {
    className: flairup.cx(styles.categoryContent)
  }, children));
}
...
function EmojiList() {
  ...
  return React.createElement("ul", {
    className: flairup.cx(styles$1.emojiList)
...
function EmojiVariationPicker() {
  ...
  return React.createElement("div", {
    ...
    className: flairup.cx(ClassNames.variationPicker, {
      visible: visible,
...
function Body() {
  ...
  useOnMouseMove();
  return React.createElement("div", {
    className: flairup.cx(styles$2.body),
    ref: BodyRef
...
function Flex(_ref) {
  ...
  return React.createElement("div", {
    ...
    className: flairup.cx(styles$3.flex, className, styles$3[direction])
  }, children);
}
var styles$3 = /*#__PURE__*/stylesheet.create((_stylesheet$create = {
  flex: {
    display: 'flex'
  }
...
function SkinTonePicker(_ref) {
  ...
  return React.createElement(Relative, {
    className: flairup.cx('epr-skin-tones', direction, (_cx = {}, _cx[ClassNames.open] = isOpen, _cx)),
    style: vertical ? {
    ...
    return React.createElement(Button, {
      ...
      className: flairup.cx("epr-tone-" + skinToneVariation, 'epr-tone', (_cx2 = {}, _cx2[ClassNames.active] = active, _cx2)),
      tabIndex: isOpen ? 0 : -1,
      "aria-pressed": active,
...
function Preview() {
  ...
  return React.createElement(Flex, {
    className: flairup.cx(styles$4.preview)
...
function CategoryNavigation() {
  ...
  return React.createElement("div", {
    ...
    return React.createElement(Button, {
      ...
      className: flairup.cx('epr-cat-btn', "epr-icn-" + category, (_cx = {}, _cx[ClassNames.active] = isActiveCategory, _cx)),
      key: category,
      onClick: function onClick() {
...
function SearchContainer() {
  ...
  return React.createElement(Flex, {
    className: flairup.cx(styles$5.overlay)
...
function Search() {
  ...
  return React.createElement(Relative, {
    ...
    role: "status",
    className: flairup.cx('epr-status-search-results', 'epr-status-visually-hidden'),
    "aria-live": "polite",
    id: "epr-search-id",
    "aria-atomic": "true"
    ...
    className: flairup.cx('epr-btn-clear-search', 'epr-visible-on-search-only'),
    onClick: clearSearch,
    "aria-label": "Clear",
    title: "Clear"
  }, React.createElement("div", {
...
function PickerRootElement(_ref2) {
  ...
  return React.createElement("aside", {
    className: flairup.cx(styles$6.main, styles$6.baseVariables, theme === exports.Theme.DARK && styles$6.darkTheme, theme === exports.Theme.AUTO && styles$6.autoThemeDark, (_cx = {}, _cx[ClassNames.searchActive] = searchModeActive, _cx), className),
    ref: PickerMainRef,
    style: style
  }, children);
}
